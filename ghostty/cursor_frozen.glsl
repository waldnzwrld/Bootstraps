...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // Cap the distance used for the settle reveal so long jumps don't drag out the tail
    float settleLength = min(lineLength, 0.35);
    ...
    fragColor = mix(trail, fragColor, 1. - smoothstep(0., sdfCurrentCursor, easedProgress * settleLength));
}
